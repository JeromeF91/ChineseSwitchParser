#!/usr/bin/env python3
"""
Test script for 10.41.8.36 switch using cookie-based authentication
"""
...
def test_switch_36_cookie():
    ...
    if "login.cgi" not in response.text:
        ...
        print("\n3. Testing info.cgi with proper headers...")
        headers = {
        ...
        if info_response.status_code == 200 and len(info_response.text) > 500:
            ...
            # Save the info page
            with open('info_page_36.html', 'w') as f:
                f.write(info_response.text)
            print("Info page saved to info_page_36.html")
            
            # Now try VLAN pages with the same headers
            ...
            for endpoint in vlan_endpoints:
                ...
                if vlan_response.status_code == 200 and len(vlan_response.text) > 500:
                    ...
                    # Save the VLAN page
                    with open('vlan_page_36_cookie.html', 'w') as f:
                        f.write(vlan_response.text)
                    print("VLAN page saved to vlan_page_36_cookie.html")
